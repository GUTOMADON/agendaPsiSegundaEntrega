...
<head>
    ...
    <title>AgendaPsi - Sistema de Agendamento de Consultas</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="cadastraConsulta.php" method="post">
                            ...
                            <div class="mb-3">
                                <label for="paciente_nome" class="form-label">Nome Completo do Paciente:</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="psicologo_id" name="psicologo_id" required>
                                    ...
                                    $sql = "SELECT id, nome FROM psicologos ORDER BY nome";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<option value=''>Nenhum psicólogo cadastrado</option>";
                                    }
                                    $banco->close();
                                    ?>
